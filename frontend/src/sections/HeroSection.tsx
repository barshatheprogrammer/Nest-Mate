...
export default function HeroSection() {
    const specialFeatures = [
        ...
        "Student-Friendly Profiles",
        "Easy & Safe Connections",
    ];
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.a href="#how-it-works" className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-pink-100 bg-pink-200/15"
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>Try NestMate Matching </span>
            ...
            >
                Find a Roommate Who Fits{" "}
                <span className="move-gradient px-3 rounded-xl text-nowrap">Your Lifestyle.</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Discover compatible students, compare lifestyles, and find a roommate who feels like home.</motion.p>
